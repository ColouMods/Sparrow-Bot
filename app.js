...
client.on('message', message => {
	...
	{
   	//const catThink = client.emojis.find("name", "catThink");
	const catThink = client.emojis.get("453222174732451853");
